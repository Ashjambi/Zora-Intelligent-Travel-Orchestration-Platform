...
const NAV_ITEMS: NavItemDef[] = [
  { href: '/', icon: <LayoutDashboard className="h-4 w-4" />, label: 'Command Center', active: true },
  { href: '/sales', icon: <Briefcase className="h-4 w-4" />, label: 'Sales Agent' },
  { href: '/marketing', icon: <Megaphone className="h-4 w-4" />, label: 'Marketing Agent' },
  { href: '/finance', icon: <Landmark className="h-4 w-4" />, label: 'Finance Agent' },
  { href: '/operations', icon: <Bot className="h-4 w-4" />, label: 'Operations Agent' },
        ...
        >
          {!collapsed && (
            <>
              ...
              <span className="flex-1 font-bold text-sm truncate tracking-tight">ZORA AGENTIC</span>
            </>
          )}
          <Tooltip>

...
export const LogoIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12 2L4 22l8-5 8 5L12 2z" />
  </svg>
);
...
// Replaced DollarSignIcon with RialSignIcon visually, keeping name for backward compatibility or better create new one.
// Creating a specific RialSignIcon
export const RialSignIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <circle cx="12" cy="12" r="10" />
        <text x="12" y="16.5" fontSize="9" textAnchor="middle" stroke="none" fill="currentColor" fontWeight="900" style={{fontFamily: 'sans-serif', letterSpacing: '-0.5px'}}>SR</text>
    </svg>
);
...
export const CarIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 16H9m10 0h1.12a1 1 0 0 0 .9-1.42l-1-3.21a1 1 0 0 0-.9-.58H4.88a1 1 0 0 0-.9.58l-1 3.21a1 1 0 0 0 .9 1.42H5m14 0v1.12a1 1 0 0 1-1.42.9l-3.21-1a1 1 0 0 1-.58-.9V16m-5 0v1.12a1 1 0 0 0 1.42.9l3.21-1a1 1 0 0 0 .58-.9V16m-5 0H5.88a1 1 0 0 0-.9 1.42l1 3.21a1 1 0 0 0 .9.58h8.24a1 1 0 0 0 .9-.58l1-3.21a1 1 0 0 0-.9-1.42H9m-4-5 4-4 4 4"/><circle cx="7" cy="19" r="1"/><circle cx="17" cy="19" r="1"/></svg>
);
...
export const TrainIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="16" height="16" x="4" y="3" rx="2" /><path d="M4 11h16" /><path d="M12 3v-2" /><path d="M8 23v-3" /><path d="M16 23v-3" /><path d="M4 19h16" /></svg>
);

export const ClipboardDocumentListIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-1.105 0-2 .895-2 2v11.25c0 1.105.895 2 2 2h14.25c1.105 0 2-.895 2-2V10.5M8.25 8.25v3.75a2.25 2.25 0 01-2.25 2.25H3.75a2.25 2.25 0 01-2.25-2.25V10.5m0 0a2.25 2.25 0 012.25-2.25h2.25" />
    </svg>
);
...
export const CrownIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2 4l3 12h14l3-12-6 7-4-7-4 7-6-7zm0 0L12 14 22 4"></path></svg>
);

export const RestaurantIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const BuildingOfficeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M8.25 6h7.5M8.25 9h7.5M8.25 12h7.5M8.25 15h7.5M8.25 18h7.5M5.25 6h.008v.008H5.25V6zm0 3h.008v.008H5.25V9zm0 3h.008v.008H5.25v-3zm0 3h.008v.008H5.25v-3zm0 3h.008v.008H5.25v-3zm13.5-9h.008v.008h-.008V9zm0 3h.008v.008h-.008v-3zm0 3h.008v.008h-.008v-3zm0 3h.008v.008h-.008v-3z" />
    </svg>
);
...
export const UserGroupIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 00-12 0m12 0a9.094 9.094 0 01-12 0m12 0v-4.5m-12 4.5v-4.5m12-4.5a9.094 9.094 0 00-12 0m12 0a9.094 9.094 0 01-12 0M12 3a9.094 9.094 0 00-9 9h18a9.094 9.094 0 00-9-9z" />
    </svg>
);
...
export const CreditCardIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75-10.5h16.5a1.5 1.5 0 011.5 1.5v10.5a1.5 1.5 0 01-1.5 1.5H3.75a1.5 1.5 0 01-1.5-1.5V6.75a1.5 1.5 0 011.5-1.5z" />
    </svg>
);
...
// FIX: Added GlobeAltIcon to be used in PartnerProfileModal.
export const GlobeAltIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c.333 0 .666-.02.992-.06M12 15c-2.485 0-4.5-2.015-4.5-4.5S9.515 6 12 6s4.5 2.015 4.5 4.5-2.015 4.5-4.5 4.5zm0 0V6m0 9v6m6-9h-3.342a4.493 4.493 0 00-1.658-3.342M3 10.5h3.342a4.493 4.493 0 011.658-3.342M14.25 10.5a4.493 4.493 0 00-1.658 3.342h-1.184a4.493 4.493 0 00-1.658-3.342M3.75 6.75c.618 0 1.221.166 1.76.467M20.25 6.75c-.618 0-1.221.166-1.76.467M12 3c.333 0 .666.02.992-.06" />
    </svg>
);

/**
 * Fix: Added PhoneIcon export to resolve the import error in ClientAuth.tsx.
 * This icon is used for the phone input field in the client registration form.
 */
